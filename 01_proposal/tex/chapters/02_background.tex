...
Dynamic scene reconstruction (as in \enquote{reconstructing a dynamic scene}) in general represents reconstruction of 3D scenes that change over time, which means the input are video feeds with a certain frame rate. 
...
\paragraph{Constrained Solutions} Single-camera setups described in Chapter \ref{ch:camera} naturally have to use some kind of prediction mechanism to show what is behind the primary geometry the camera can capture.


\paragraph{Unconstrained Solutions}
